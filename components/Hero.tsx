...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 py-16 sm:py-20">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto text-center px-2">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight mb-6 leading-tight"
        >
          Building the{' '}
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl text-foreground/70 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-2"
        >
        ...
        >
          <a
            href="#contact"
            className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-accent hover:bg-accent-hover text-background font-semibold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-accent/20 hover:shadow-accent/40 touch-manipulation"
          >
            Start Your Project
          ...
          <a
            href="#services"
            className="px-6 sm:px-8 py-3 sm:py-4 border border-border hover:border-accent/50 bg-muted/50 hover:bg-muted text-foreground font-semibold rounded-lg transition-all duration-300 backdrop-blur-sm text-center touch-manipulation"
          >
            Our Services
          </a>
        </motion.div>
